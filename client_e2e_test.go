...
// TestEnvInfo holds the standard LOG_TEST_* env vars consumed by every
// e2e suite in this package. Defined here so other e2e files (build
// tag e2e) can reference it without declaring duplicates.
